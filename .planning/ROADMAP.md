...
- [x] 13-03-PLAN.md — All /api/** route handlers: modules, bridge, hub tree/file, SSE chat proxy, zod schemas (Wave 3, parallel with 13-04)
- [x] 13-04-PLAN.md — Python loopback engine (bot/engine/*) with owner-lock + SSE generator, bot/main.py supervises both processes (Wave 3, parallel with 13-03)
- [x] 13-05-PLAN.md — Pages: chat+tree unified page, login widget, modules/bridge with rhf+zod, 7 Playwright E2E specs (Wave 4)
- [x] 13-06-PLAN.md — Cutover: delete bot/dashboard/*, Bun-stage Dockerfile, ROADMAP reorder, manual LXC smoke (Wave 5, checkpoint)
